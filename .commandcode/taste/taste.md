...
- Delegates the full finalization of a fix: a single terse "perbaiki lalu push" is expected to cover repairing the issue, re-running the test suites to confirm no regression, then committing and pushing to the remote (origin/main) — no further confirmation asked. Confidence: 0.7
